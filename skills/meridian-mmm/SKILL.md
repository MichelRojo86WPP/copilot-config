...
description: >
  ...
  presupuesto cross-channel (con y sin Reach & Frequency), y casos de uso WPP/Meliá. Usar al
...
- Aplicar Meridian a un caso de negocio WPP/Meliá (medición de campaña, cross-channel, geo EMEA).
...
- **[references/wpp-melia-context.md](references/wpp-melia-context.md)** — casos de uso reales de Meliá (medición de campaña, optimización cross-channel, geo EMEA, integración BRAIN_EMEA.xlsx, troubleshooting, integración con CausalImpact/Looker Studio, best practices) con código usando el API real. Leer para trabajo aplicado al cliente Meliá.
...
- Casos de uso y troubleshooting específicos de Meliá.
