# Meridian MMM — Patrones de aplicación práctica (WPP Media)

> Parte de la skill meridian-mmm. Cargar este archivo para patrones de uso reales: medición de
> campañas, optimización cross-channel, análisis geo multi-país, troubleshooting,
> integración con CausalImpact/Looker Studio, y best practices del equipo.

> **Nota:** este documento recoge únicamente conocimiento **portable** de WPP Media, reutilizable con cualquier cliente. El contexto específico de cada cliente (datos propios, taxonomías internas, integraciones a sistemas del cliente) vive en el repositorio de ese cliente, no aquí.

---

## PARTE V — PATRONES DE APLICACIÓN PRÁCTICA

> **Nota de corrección (2026-09-01):** la versión anterior de este documento contenía ejemplos
> de código basados en una API **inventada**
...
### 1. Medición de impacto de una campaña (ej. campaña de verano)
...
### 2. Optimización de presupuesto cross-channel
...
### 3. Análisis geo-level (multi-país: España, UK, Francia…)
...
### 4. Troubleshooting rápido (con el API real)
...
### 5. Integración con TFP CausalImpact
...
### 6. Con Looker Studio (Scenario Planner)
